...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin.ArgsUpdateBan"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin.ArgsChangePassword"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/admin.ConnectionJSON"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin.ArgsLogin"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/admin.ResponseSearchByIPJSON"
                                            }
                                        }
                                    }
                                }
        ...
        "/admin/user/{user_id}/connections": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/admin.ResponseConnectionsJSON"
                                            }
                                        }
                                    }
                                }
        ...
        "/admin/user/{user_id}/emblem": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Emblem Data",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin.ArgsUpdateEmblem"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/user/{user_id}/shared_accounts": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/admin.SharedAccountsJSON"
                                            }
                                        }
                                    }
                                }
